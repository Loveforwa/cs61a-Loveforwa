def divide(quotients, divisors):
    ...
    """
    return {i: [it for it in divisors if it % i == 0] for i in quotients}
...
def buy(fruits_to_buy, prices, total_amount):
    ...
    return add(fruits_to_buy, total_amount, '')
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    if distance(make_city('non',lat,lon),city_a) < distance(make_city('non',lat,lon),city_b):
