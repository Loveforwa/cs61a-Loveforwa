...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    score = 3 * abs(player_score % 10 - opponent_score // 10)
    if score < 1:
        return 1
    else:
        return score
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    sus_score = sus_points(score + boar_score)
